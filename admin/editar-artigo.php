...
<body>
    <div id="container">
        <h1>Editar Artigo</h1>
        <form action="../admin/editar-artigo.php" method="post">
            <p>
            ...
            <p>
                ...
                <textarea class="campo-form conteudo-form" type="text" name="conteudo" id="titulo">
